  ...
  return (<Box>
    <List>
      ...
      <ListItem>
        ...
        <ListItemText primary="ETF8222 Ülekantud tähenduses fraasid eesti keele korpustes"/>
      </ListItem>
      <ListItem>
        <ListItemIcon>
          <FiberManualRecordIcon/>
        </ListItemIcon>
        <ListItemText primary="EKKM15-419 Eesti õppijakeele tervikkäsitlus (2015−2018)"/>
      </ListItem>
      <ListItem>
        <ListItemIcon>
          <FiberManualRecordIcon/>
      ...
      <ListItem>
        ...
        <ListItemText primary="TF2621 ELLE: eesti keele õpet toetav keeletehnoloogiline ressurss (2021−2023)"/>
      </ListItem>
      <ListItem>
        <ListItemIcon>
          <FiberManualRecordIcon/>
        </ListItemIcon>
        <ListItemText primary="EKTB Eestikeelse teksti automaatkorrektuur (2021−2023, koostöös Tartu Ülikooliga)"/>
      </ListItem>
    </List>
  </Box>)
