        ...
        <form onSubmit={this.handleSubmit}
                    ...
                    {this.state.liik === "mitteakadeemiline" && <Grid>
                      <FormControl size="small"
                        ...
                        >
                          ...
                          <MenuItem value={"k2eesti_keeleope"}
                                    disabled>K2 keeleõpe</MenuItem>
                          ...
                          <MenuItem value={"k2eesti_harjutus_ots"}
                                    disabled>K1 eesti keel</MenuItem>
          ...
          <div className="buttonHolder">
            <Grid style={{paddingTop: "40px"}}
                  ...
                  spacing={1}>
              <Grid item>
                <Alert severity="info"><Typography fontSize={12}>Teksti üles laadides
                  nõustun <u style={{cursor: "pointer"}}
