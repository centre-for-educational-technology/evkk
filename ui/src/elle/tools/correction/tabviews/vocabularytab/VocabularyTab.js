...
import { markText } from './helperFunctions/vocabularyMarkingHandlers';
        ...
        <CorrectionInfoIcon
          inputText={<div>
            ...
            <ul>
              ...
              <li>
                <b>{t('corrector_vocabulary_infobox_noun_abstractness_bold')}</b> {t('corrector_vocabulary_infobox_noun_abstractness_value')}{toolLink}{t('corrector_vocabulary_infobox_noun_abstractness_value_second')} {dataLink} {t('corrector_vocabulary_infobox_noun_abstractness_value_end')}
              </li>
              <li>
