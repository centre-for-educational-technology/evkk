...
export const checkIfOneOrTwoWords = (errorWord, correctedWord) =>
...
export const checkIfSpellingError = (errorWord, correctedWord) => {
...
export const checkForExtraWordError = (errorWord, correctedWord) => {
