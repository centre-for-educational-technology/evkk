        ...
        <Box sx={{
          ...
          <Box>
            <Typography id={"meediatekstid"}
                        variant={"h3"}>Meediatekstid</Typography>
          </Box>

          <Box>
            <Typography id={"kirjandus"}
                        variant={"h3"}>Kirjandus</Typography>
          </Box>

          <Box>
            <Typography id={"teadustekstid"}
                        variant={"h3"}>Teadustekstid</Typography>
          </Box>

          <Box>
            <Typography id={"video"}
                        variant={"h3"}>Video</Typography>
          </Box>

          <Box>
            <Typography id={"audio"}
                        variant={"h3"}>Audio</Typography>
          </Box>
          ...
          <Box>
            <Typography id={"keelekorpused"}
                        variant={"h3"}>Eesi keele korpused</Typography>
          </Box>
