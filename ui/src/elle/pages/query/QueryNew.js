...
import QueryResults from './QueryResultsNew';
...
export default function Query() {
  ...
  const setButtonClass = (id) => {
    document.getElementById(id).classList.add("button-box-open")
  }
    ...
    <div>
      ...
      <div className="buttonBox">
        <Button variant="contained"
          ...
          <div className="button-text-query"><ManageSearchIcon
            style={{fontSize: "40px", marginLeft: "15px", marginRight: "10px"}}/><span
            style={{fontSize: "15px", fontWeight: "bold"}}>{t('query_choose_texts')}</span></div>
        </Button>
        <Box id="menu-box-choose-text" hidden={filterOpen} className="menu-box-choose-text">
          {!queryAnswer ?
            <form action=""
                  onSubmit={(e) => {
                    e.preventDefault();
