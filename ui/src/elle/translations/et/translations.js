export const TRANSLATIONS_ET = {
  ...
  middle: 'keskel',
  neighboring_words_case_sensitive_hover: 'Vaikimisi ei arvestata otsisõna suurt või väikest algustähte, nt "eesti" võimaldab leida nii "eesti" kui ka "Eesti" naabersõnad. Märgi kasti linnuke, kui soovid ainult väike- või suurtähega algavaid vasteid.',
  neighboring_words_choose_statistic_measure: 'Vali valem',
  neighboring_words_collocation: 'Naabersõna',
  neighboring_words_frequency_in_text: 'Sagedus tekstis',
  neighboring_words_keyword_lemmatization_warning: 'Otsisõna "{initialKeywordResult}" vasteid ei leitud. Kasutasime automaatset algvormi tuvastust ja otsisime sõna "{lemmatizedKeywordResult}" naabersõnu.',
  neighboring_words_number_of_co_occurrences: 'Kooskasutuste arv',
  neighboring_words_percentage_in_text: 'Osakaal tekstis',
  neighboring_words_score: 'Skoor',
  neighboring_words_search_for_neighboring_words: 'Otsi naabersõnu',
  neighboring_words_search_within_preceding_and_following_words: 'eelneva ja järgneva sõna piires',
  neighboring_words_statistic_measure_hover: 'Pakume naabersõnade leidmiseks kolme valemit, mis annavad mõnevõrra erinevaid tulemusi. logDice ei sõltu teksti pikkusest ja sobib seega kõige paremini mahukate tekstikogude analüüsimiseks. Üksikute tekstide puhul on logDice\'i ja T-skoori alusel saadud tulemused üsna sarnased. MI-skoor toob paremini esile harvaesinevaid sõnaühendeid, kuid määrab oluliste naabersõnade hulka ka rohkem sisutühje sõnu, mis esinevad paljude sõnade lähiümbruses.',
  neighboring_words_statistic_measure_logdice: 'logDice',
  neighboring_words_statistic_measure_mi_score: 'MI-skoor',
  neighboring_words_statistic_measure_t_score: 'T-skoor',
