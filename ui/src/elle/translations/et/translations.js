export const TRANSLATIONS_ET = {
  ...
  error_analyser_r_spell: 'Õigekiri',
  error_analyser_r_case: 'Algustäht',
  error_analyser_r_nom_form: 'Käändsõna vormivalik',
  error_analyser_r_verb_form: 'Tegusõna vormivalik',
  error_analyser_r_lex: 'Sõnavalik',
  error_analyser_m_lex: 'Puuduv sõna',
  error_analyser_u_lex: 'Liigne sõna',
  error_analyser_punctuation: 'Kirjavahemärgivead',
  error_analyser_r_punct: 'Vigane kirjavahemärk',
  error_analyser_m_punct: 'Puuduv kirjavahemärk',
  error_analyser_u_punct: 'Liigne kirjavahemärk',
  error_analyser_r_ws: 'Kokku- ja lahkukirjutus',
  error_analyser_r_wo: 'Sõnajärg',
  ...
  error_analyser_text_type: 'Tekstiliik',
  ...
  error_analyser_source_sentence: 'Algne lause',
  error_analyser_corrected_sentence: 'Parandatud lause',
