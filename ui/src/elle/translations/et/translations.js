export const TRANSLATIONS_ET = {
  ...
  query_common_author_data: 'Autori andmed',
  ...
  query_common_language_ca: 'katalaani',
  query_common_language_cz: 'tšehhi',
  ...
  query_common_language_he: 'heebrea',
  query_common_language_hu: 'ungari',
  query_common_language_it: 'itaalia',
  ...
  query_subcoprus_L2_olympiade_hover: 'Sisaldab eri emakeelega õpilaste eesti keele olümpiaadi esseid',
  query_subcorpus: 'Alamkorpus',
  query_subcorpus_L1_estonian: 'K1 eesti keel',
  query_subcorpus_L1_estonian_hover: 'Võrdluskorpus, sisaldab emakeelekõnelejate arvamuslugusid ajalehtedest',
  ...
  query_subcorpus_L2_estonian_hover: 'Sisaldab eksamiväliselt kirjutatud A2-, B1-, B2- ja C1-taseme tekste, mille tase on määratud kolme tunnustatud hindamise spetsialisti ühise arvamuse põhjal',
  query_subcorpus_L2_proficiency_examinations: 'K2 riiklikud eksamitööd',
  query_subcorpus_L2_proficiency_examinations_hover: 'Sisaldab riiklikke eksami- ja tasemetöid',
  ...
  query_subcorpus_academic_estonian_hover: 'Sisaldab emakeelekõneleja ja eesti keelt teise keelena kasutava üliöpilase akadeemilise keelekasutuse näiteid (referaadid, seminaritööd, lõputood jm)',
  query_subcorpus_all: 'kõik',
  query_text_data: 'Teksti andmed',
  query_text_data_char_over_5000: 'üle 5000',
  query_text_data_char_up_to_500: 'kuni 500',
  query_text_data_characters: 'Tähemärke',
  query_text_data_field_of_research: 'Valdkond',
  query_text_data_field_of_research_biosciences_and_environment: 'Bio- ja keskkonnateadused',
  query_text_data_field_of_research_culture_and_society: 'Ühiskonnateadused ja kultuur',
  query_text_data_field_of_research_health: 'Terviseuuringud',
  query_text_data_field_of_research_natural_sciences_and_engineering: 'Loodusteadused ja tehnika',
  ...
  query_text_data_type_L2_exercise_answering_questions: 'Vastused',
  ...
  query_text_data_type_L2_olympiade_creative_writing: 'K2 OT loovkirjutis',
  query_text_data_type_L2_proficiency_examination: 'K2 riiklik eksamitöö',
  ...
  query_text_data_used_study_or_supporting_materials_other: 'Muu',
