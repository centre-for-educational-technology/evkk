export const TRANSLATIONS_ET = {
  ...
  footer_links: 'Viited',
  footer_texts_and_tools: 'Tekstid ja tööriistad',
  footer_link_collections: 'Lingikogu',
  footer_about: 'Keskkonnast',
  footer_about_grants: 'Grandid',
  footer_about_people: 'Töötajad',
  footer_about_publications: 'Üllitised',
  footer_about_publications_conferences: 'Konverentsid ja töötoad',
  footer_about_publications_thesis: 'Lõputööd',
  footer_about_publications_publications: 'Publikatsioonid',
  footer_about_us: 'Meist',
  footer_links_adding: 'Loovuta oma tekst',
  footer_links_collocates: 'Nabersõnad',
  footer_links_elle_github: 'ELLE Github repositoorium',
  footer_links_elle_license: 'ELLE litsents',
  footer_links_evkk: 'Eesti vahekeele korpus',
  footer_links_evkk_license: 'EVKK litsents',
  footer_resources_teacher_aid: 'Abiks õpetajale',
  footer_resources_audiovisual: 'Audiovisuaalne meedia',
  footer_resources_estonian: 'Eestikeelsed tekstid',
  footer_resources_language_corp: 'Eesti keele korpused',
  footer_resources_language_tools: 'Keeleõppevara',
  footer_resources_environments_courses: 'Keeleõppekeskkonnad ja kursused',
  footer_resources_dictionaries: 'Sõnastikud',
  footer_resources_introduction: 'Tutvustus',
  footer_resources_translate_tools: 'Tõlkerakendused',
  footer_tools_clusterfinder: 'Mustrileidja',
  footer_tools_collocates: 'Nabersõnad',
  footer_tools_wordanalyser: 'Sõnaanalüsaator',
  footer_tools_wordcontext: 'Sõna kontekstis',
  footer_tools_wordlist: 'Sõnaloend',
  forward: 'JÄRGMINE',
