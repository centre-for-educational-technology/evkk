export const TRANSLATIONS_ET = {
  ...
  common_studymaterial: 'Õppematerjal',
  ...
  modal_close_confirmation_popup: 'Kas oled kindel, et soovid katkestada? Muudatusi ei salvestata.',
  exercise_modal_duration: 'Kestvus',
  exercise_modal_proceed: 'Jätka',
  exercise_page_create_new_exercise: 'Loo Uus Harjutus',
  exercise_creation_guide: 'Harjutuse loomise juhend',
  exercise_creation_guide_step_1: 'Ava sisuloome tööriist',
  exercise_creation_guide_step_2: 'Täida harjutuse sisu ja vali sobiv harjutuse tüüp',
  exercise_creation_guide_step_3: 'Vajuta "Salvesta", et harjutus salvestada',
  exercise_creation_guide_step_4: 'Valuta "Kopeeri link", et saada harjutuse link',
  exercise_creation_guide_step_5: 'Kleebi kopeeritud link allolevasse lahtrisse',
  exercise_creation_insert_link: 'Sisesta link',
  exercise_creation_verify_link: 'Kontrolli link',
  exercise_creation_back: 'Tagasi',
  exercise_creation_show_preview: 'Kuva eelvaadet',
  exercise_creation: 'Harjutuste loomine',
  ...
  study_material_inspect_title: 'Pealkiri',
  study_material_inspect_description: 'Kirjeldus',
  ...
  sort_older_first: 'Vanemad enne',
  sort_newer_first: 'Uuemad enne',
  filter_categories_button: 'Kategooriad',
  filter_language_level_button: 'Keeletase',
  filter_type_button: 'Tüüp',
  paginator_previous: 'Eelmine',
  paginator_page: 'Leht',
  paginator_next: 'Järgmine',
