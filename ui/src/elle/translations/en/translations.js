export const TRANSLATIONS_EN = {
  ...
  common_text_data_type_L2_olympiade_creative_writing:
    'L2 olympiade creative writing',
  common_text_data_type_L2_proficiency_examination:
    'L2 proficiency examination',
  ...
  concordances_case_sensitive_hover:
    'Search words beginning with uppercase or lowercase letters are not recognized by default, e.g. searching for "eesti" allows you to find the contexts of both "eesti" and "Eesti". Tick the box if you only want the results beginning with uppercase or lowercase letters.',
  concordances_following_context: 'Following context',
  concordances_keyword_lemmatization_warning:
    'The keyword "{{initialKeywordResult}}" had no matches. Automatic lemmatization was used and contexts for the word "{{lemmatizedKeywordResult}}" were found.',
  ...
  corpus_donation_text:
    'Help us research Estonian language and donate your writing to our text collection. Texts from both language learners and native speakers are appreciated.',
  ...
  error_analyser_title: 'Error Analyser',
  ...
  error_no_matching_keywords:
    'The keyword could not be found in the text. Change the analysis options and try again!',
  ...
  hero_main_text_highlighted:
    'Estonian language learning and analysis environment',
  ...
  homepage_box_clusters_content:
    'allows you to find typical word sequences from the text.',
  homepage_box_clusters_title: 'Cluster Catcher',
  homepage_box_concordances_content:
    'allows you to explore the usage of a chosen word.',
  homepage_box_concordances_title: 'Word in Context',
  homepage_box_corrector_content:
    'allows you to evaluate your writing. You can see what the robot thinks about the spelling of your text and what language proficiency level it corresponds to.',
  homepage_box_corrector_title: 'Writing Evaluator',
  homepage_box_neighbouring_words_content:
    'allows you to find words that often co-occur in the text.',
  homepage_box_neighbouring_words_title: 'Neighbouring Words',
  homepage_box_query_content:
    'allows you to search for language material in EIC text collections based on author and text data. You can also submit your own text for research.',
  homepage_box_query_title: 'Text query',
  homepage_box_word_analysis_content:
    'allows you to assess your writing. See what the robot thinks about the spelling and complexity of your text and what proficiency level it corresponds to.',
  homepage_box_word_analysis_title: 'Word Analyser',
  homepage_box_wordlist_content:
    'allows you to see which words occur most frequently in the text.',
  homepage_box_wordlist_title: 'Wordlist',
  homepage_services_title: 'What can you do in ELLE?',
  homepage_summary_text_1:
    'Apply data-driven learning where the learner can derive or confirm language rules on their own based on authentic language material.',
  homepage_summary_text_2:
    'Edit texts written in educational as well as work settings, e.g., correct written assignments and simplify official texts.',
  homepage_summary_text_3:
    'Check student writings, choose and compile tutoring materials based on typical language use of learners at various proficiency levels.',
  homepage_summary_text_4:
    'Analyse the content and language use of texts for research purposes, e.g., in language, culture and media studies.',
  homepage_summary_title: 'What does ELLE support?',
  homepage_title:
    'ELLE - Estonian Language Learning, Teaching and Research Environment',
  homepage_title_explainer:
    'ELLE offers text collections and text analysis tools for learning and teaching Estonian both as a second and native language, as well as for language research. The text query enables you to find materials from the Estonian Interlanguage Corpus (EIC) that mostly includes writings by learners of Estonian as a second language, but also examples of native language use and academic texts. Additionally, the tools allow you to analyse the vocabulary and grammar of self-selected texts, check their readability score and assess their language proficiency level.',
  input_field_tutorial_text:
    'You can click on the words in this textbox. Clicking them will highlight the selected word.',
  lemmas_filename: 'baseforms',
  lemmas_header_wordforms: 'Word forms',
  middle: 'middle',
  neighbouring_words_case_sensitive_hover:
    'Search words beginning with uppercase or lowercase letters are not recognized by default, e.g. searching for "eesti" allows you to find the neighbouring words of both "eesti" and "Eesti". Tick the box if you only want the results beginning with uppercase or lowercase letters.',
  ...
  neighbouring_words_keyword_lemmatization_warning:
    'The keyword "{{initialKeywordResult}}" had no matches. Automatic lemmatization was used and neighbouring words for the word "{{lemmatizedKeywordResult}}" were found.',
  ...
  neighbouring_words_search_for_neighbouring_words:
    'Search for neighbouring words',
  neighbouring_words_search_within_preceding_and_following_words:
    'within preceding and following words',
  ...
  publish_your_text_author_data_other_languages_tooltip:
    'Enter the languages, separated by commas, starting with the language you understand best',
  publish_your_text_content: 'Text',
  publish_your_text_content_helper_text:
    'Upload your text or enter it into the text box',
  ...
  publish_your_text_terms_of_service_1:
    'I grant permission to use my text and background data for academic and educational purposes by researchers and students, teachers and learners as well as software developers.',
  publish_your_text_terms_of_service_2:
    'Personal data has been removed, and the author is not identified in the database. If a publicly accessible text is to be added to the corpus, the licensing terms of the publication must be followed. All copyrights are reserved.',
  publish_your_text_terms_of_service_infobox_1:
    'By publishing the text, I agree to the ',
  ...
  publish_your_text_text_data_supporting_material:
    'Study or supporting material',
  publish_your_text_text_data_supporting_material_other:
    'Other study or supporting material',
  ...
  query_subcoprus_L2_olympiade_hover:
    'Includes creative writings from the olympiade of Estonian as a second language.',
  query_subcorpus: 'Subcorpus',
  query_subcorpus_L1_estonian: 'L1 Estonian',
  query_subcorpus_L1_estonian_hover:
    "Reference corpus, includes mainly native speakers' opinion pieces from newspapers.",
  query_subcorpus_L1_russian: 'L1 Russian',
  query_subcorpus_L1_russian_hover:
    "Includes elementary school and high school Russian-speaking students' texts of a creative nature.",
  query_subcorpus_L2_estonian: 'L2 Estonian',
  query_subcorpus_L2_estonian_hover:
    'Includes Estonian learner writings produced outside examination situations. A number of texts have received a proficiency assessment (level A1-C2) by at least two recognized specialists.',
  query_subcorpus_L2_proficiency_examinations:
    'Estonian L2 proficiency examinations',
  query_subcorpus_L2_proficiency_examinations_hover:
    'Includes writings from Estonian language proficiency examinations.',
  query_subcorpus_L3_russian: 'L3 Russian',
  query_subcorpus_L3_russian_hover:
    'Includes texts written by native Estonian students learning Russian as their third language at school.',
  query_subcorpus_academic_estonian: 'Academic Estonian',
  query_subcorpus_academic_estonian_hover:
    'Includes examples of academic language use (reports, term papers, theses etc.) by students speaking Estonian as a first or second language.',
  ...
  query_text_data_type_L1_russian_creative_writing:
    'L1 Russian creative writing',
  ...
  query_text_data_type_L2_exercise_answering_questions_full:
    'L2 exercise: answering questions',
  ...
  query_text_data_type_L2_exercise_fill_in_the_blanks_full:
    'L2 exercise: fill-in-the-blanks',
  ...
  query_text_data_type_L2_exercise_sentence_construction_full:
    'L2 exercise: sentence construction',
  ...
  query_text_data_type_L3_russian_creative_writing:
    'L3 Russian creative writing',
  ...
  query_text_data_type_academic_research_bachelors_thesis_full:
    "Academic research: bachelor's thesis",
  ...
  query_text_data_type_academic_research_doctoral_thesis_full:
    'Academic research: doctoral thesis',
  ...
  query_text_data_type_academic_research_masters_thesis_full:
    "Academic research: master's thesis",
  ...
  query_text_data_type_academic_studies_seminar_paper_full:
    'Academic studies: seminar paper',
  ...
  query_text_data_used_study_or_supporting_materials:
    'Used study or supporting materials',
  ...
  query_text_data_used_study_or_supporting_materials_monolingual_dictionary:
    'Monolingual dictionary (incl. online dictionaries)',
  ...
  server_offline_page_error:
    'ELLE services are unavailable at the moment! Please try again later.',
  start_button: 'Start',
  ...
  table_click_tutorial_text:
    'Clicking on a value in the table will highlight all the words connected with the value in the textbox above.',
  table_tab_tutorial_text:
    'Here you can select, what info you want to have displayed on the tables below.',
  table_tutorial_text:
    'The tables display information about the words in the textbox above.',
  ...
  tools_accordion_analysis_infobox:
    "To use the tools in gray, first select or upload text(s). It's not possible to direct texts into other tools: enter these in the text box or upload them.",
  tools_accordion_clusters_explainer:
    'Clusters or n-grams help you find typical word sequences in the text',
  tools_accordion_neighbouring_words_explainer:
    'Find words that are often used together in the text',
  tools_accordion_word_analysis_explainer:
    'Find syllables, lexical and grammatical forms of words',
  tools_accordion_word_in_context_explainer:
    "View a word's surroundings for a better overview of how it is used",
  tools_accordion_wordlist_explainer:
    'View text words by frequency or in alphabetical order',
  tools_infobox:
    'Search for texts in our EIC text collection and analyse them with our tools or upload your own text(s) for analysis.',
  tools_title: 'ELLE tools',
  tools_video_text: 'Watch introductory video',
  tools_warning_text:
    'To use this tool, please choose a text or texts to analyse from the menu on the left!',
  try_again: 'Try again',
  word_analysis_infobox_1:
    'With this app, you can syllabify words, see their base form and grammatical description. Insert a word or text (up to 1,000 words).',
  word_analysis_infobox_2:
    'You can analyse words one by one and see statistics about the syllables, words and grammatical forms used in text.',
  wordcontext_filename: 'wordcontext',
  wordinfo_tutorial_text:
    'Clicking on a word will display the grammatical info of the word.',
  wordinfo_word: 'Word',
  ...
  wordlist_retain_uppercase_letters_hover:
    'The words will be converted to lowercase by default, for example "kool" and "Kool" will be considered the same word. Tick the box if you want uppercase and lowercase words to be counted separately (e.g. "Eesti" and "eesti").',
  ...
  wordlist_set_minimum_word_frequency_hover:
    'If, for example, you want to exclude words that occur only once in a text, set the lower frequency limit to 2. When analysing large text collections, words that occur less than 5 times are often excluded.',
  ...
  wordlist_stopwords_textbox_hover_1:
    'The list of Estonian stop words was compiled by Kristel Uiboaed. It includes conjunctions, pronouns, light verbs and prepositions. The list is available in the data repository of Tartu University (see ',
