export const TRANSLATIONS_EN = {
  ...
  publish_your_text_author_data_education_basic: 'basic education',
  publish_your_text_author_data_education_elementary: 'elementary education',
  publish_your_text_author_data_education_higher: 'higher education',
  publish_your_text_author_data_education_higher_applied: 'applied higher education',
  publish_your_text_author_data_education_secondary: 'secondary education',
  publish_your_text_author_data_education_secondary_special: 'secondary special education',
  ...
  publish_your_text_terms_of_service_1: 'I grant permission to use my text and background data for the purposes of academic work and language learning by professors and students, teachers and learners, researchers, and software developers.',
  publish_your_text_terms_of_service_2: 'Personal data has been removed, and the author is not identified in the database. If publicly accessible text is to be added to the corpus, the licensing terms of the publication must be followed. All copyrights are reserved.',
  ...
  query_subcoprus_L2_olympiade_hover: 'Includes Estonian olympiade essays of students with various native languages',
  query_subcorpus: 'Subcorpus',
  query_subcorpus_L1_estonian: 'L1 Estonian',
  query_subcorpus_L1_estonian_hover: 'Reference corpus, includes native speakers\' opinion pieces from newspapers',
  ...
  query_subcorpus_L2_estonian_hover: 'Includes A2, B1, B2 and C1 level texts written outside of examinations with levels determined based on the joint opinion of three recognized evaluation specialists',
  query_subcorpus_L2_proficiency_examinations: 'Estonian L2 proficiency examinations',
  query_subcorpus_L2_proficiency_examinations_hover: 'Includes Estonian L2 proficiency examinations and academic placement tests',
  query_subcorpus_L3_russian: 'L3 Russian',
  query_subcorpus_L3_russian_hover: 'Includes texts written by native Estonian students studying Russian as their third language at school',
  query_subcorpus_academic_estonian: 'Academic Estonian',
  query_subcorpus_academic_estonian_hover: 'Includes examples of academic language use (reports, seminar papers, term papers, etc.) by a native speaker of Estonian and a student using Estonian as a second language',
