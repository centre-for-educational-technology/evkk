export const TRANSLATIONS_EN = {
  ...
  footer_links: 'Links',
  footer_texts_and_tools: 'Texts and tools',
  footer_link_collections: 'Link collections',
  footer_about: 'About',
  footer_about_grants: 'Grants',
  footer_about_people: 'Employees',
  footer_about_publications: 'Publications',
  footer_about_publications_conferences: 'Conferences and workshops',
  footer_about_publications_thesis: 'Theses',
  footer_about_publications_publications: 'Publications',
  footer_about_us: 'About us',
  footer_links_adding: 'Submit your text',
  footer_links_collocates: 'Collocates',
  footer_links_elle_github: 'ELLE Github repository',
  footer_links_elle_license: 'ELLE license',
  footer_links_evkk: 'Estonian interlanguage corpus',
  footer_links_evkk_license: 'EVKK license',
  footer_resources_teacher_aid: 'Teacher aid',
  footer_resources_audiovisual: 'Audiovisual media',
  footer_resources_estonian: 'Estonian texts',
  footer_resources_language_corp: 'Estonian language corpora',
  footer_resources_language_tools: 'Language learning tools',
  footer_resources_environments_courses: 'Language learning environments and courses',
  footer_resources_dictionaries: 'Dictionaries',
  footer_resources_introduction: 'Introduction',
  footer_resources_translate_tools: 'Translation tools',
  footer_tools_clusterfinder: 'Pattern finder',
  footer_tools_collocates: 'Collocates',
  footer_tools_wordanalyser: 'Word analyzer',
  footer_tools_wordcontext: 'Word in context',
  footer_tools_wordlist: 'Word list',
  forward: 'NEXT',
