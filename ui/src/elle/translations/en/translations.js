export const TRANSLATIONS_EN = {
  ...
  cookie_acknowledgement_snackbar_button: 'Understood',
  ...
  error_id_code_missing: 'Login failed. Save your personal code to your HarID account to log in to ELLE. After that, close your browser window and log in to ELLE in a new window.',
  ...
  session_expiration_modal_renew: 'Extend',
