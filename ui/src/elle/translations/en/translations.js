export const TRANSLATIONS_EN = {
  ...
  common_corrector: 'The Writing Evaluation Tool',
  ...
  common_neighboring_words: 'Neighboring Words',
  ...
  common_upload_own_texts: 'Upload your own text',
  common_us: 'Us',
  common_view: 'View',
  ...
  middle: 'middle',
  neighboring_words_case_sensitive_hover: 'Search words beginning with uppercase or lowercase letters are not recognized by default, e.g. searching for "eesti" allows you to find the neighboring words of both "eesti" and "Eesti". Tick the box if you only want the results beginning with uppercase or lowercase letters.',
  neighboring_words_choose_statistic_measure: 'Choose a statistic measure',
  neighboring_words_collocation: 'Neighboring word',
  neighboring_words_frequency_in_text: 'Frequency in text',
  neighboring_words_keyword_lemmatization_warning: 'The keyword "{{initialKeywordResult}}" had no matches. Automatic lemmatization was used and neighboring words for the word "{{lemmatizedKeywordResult}}" were found.',
  neighboring_words_number_of_co_occurrences: 'Number of co-occurrences',
  neighboring_words_percentage_in_text: 'Percentage in text',
  neighboring_words_score: 'Score',
  neighboring_words_search_for_neighboring_words: 'Search for neighboring words',
  neighboring_words_search_within_preceding_and_following_words: 'within preceding and following words',
  neighboring_words_statistic_measure_hover: 'We offer three statistic measures for finding neighboring words, which give slightly different results. logDice is independent of the text length and is therefore best suited for analysing large text collections. For individual texts, the results obtained with logDice and T-score are quite similar. The MI-score is better at highlighting low-frequency word combinations, but it also identifies more empty words, which occur in close proximity of many words, as important neighboring words.',
  neighboring_words_statistic_measure_logdice: 'logDice',
  neighboring_words_statistic_measure_mi_score: 'MI-score',
  neighboring_words_statistic_measure_t_score: 'T-score',
  ...
  tools_accordion_neighboring_words_explainer: 'Find words that often appear in the text together',
  tools_accordion_word_analysis_explainer: 'Find syllables, lexical and grammatical forms of words',
  tools_accordion_word_in_context_explainer: 'For a better overview of how a word is used, view its surroundings in the text',
  tools_accordion_wordlist_explainer: 'View text words in alphabetical order or by frequency',
  tools_infobox: 'Search for texts in our EIC text collection and analyze them with our tools or upload your own text(s) for analysis.',
  try_again: 'Try again',
