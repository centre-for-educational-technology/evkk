...
export const TabStyle = {
  '& button:hover': {
    backgroundColor: 'rgba(204, 168, 253, 1)',
    transition: '0.5s',
  },
...
export const ElleOuterDivStyle = {
  background:
    'linear-gradient(315deg, rgba(156, 39, 176, 1) 0%, rgba(156, 39, 176, 1) 33%, rgba(204, 168, 253, 1) 33%, rgba(204, 168, 253, 1) 67%, rgba(255, 208, 253, 1) 67%, rgba(255, 208, 253, 1) 100%)',
  height: '100%',
  width: '100%',
  padding: '7px',
};
...
export const textTypes = {
  ...
  k2eesti_harjutus_kirjeldus:
    'query_text_data_type_L2_exercise_description_full',
  k2eesti_harjutus_kuulutus:
    'query_text_data_type_L2_exercise_announcement_full',
  k2eesti_harjutus_kone: 'query_text_data_type_L2_exercise_speech_full',
  k2eesti_harjutus_laused:
  ...
  k2eesti_harjutus_vastused:
    'query_text_data_type_L2_exercise_answering_questions_full',
  k2eesti_harjutus_umberjutustus:
    'query_text_data_type_L2_exercise_retelling_full',
...
export const textTypesOptions = {
  clWmOIrLa: {
    k2eesti_riiklik_eksamitoo:
      'common_text_data_type_L2_proficiency_examination',
  },
  cFqPphvYi: {
    k2eesti_ol_loovkirjutis:
      'common_text_data_type_L2_olympiade_creative_writing',
  ...
  cFOoRQekA: {
    ...
    query_text_data_type_L2_exercise: {
      ...
      k2eesti_harjutus_kirjeldus:
        'query_text_data_type_L2_exercise_description',
      k2eesti_harjutus_kuulutus:
        'query_text_data_type_L2_exercise_announcement',
      k2eesti_harjutus_kone: 'query_text_data_type_L2_exercise_speech',
      k2eesti_harjutus_laused:
        'query_text_data_type_L2_exercise_sentence_construction',
      k2eesti_harjutus_leping: 'query_text_data_type_L2_exercise_contract',
      k2eesti_harjutus_lunktekst:
        'query_text_data_type_L2_exercise_fill_in_the_blanks',
      ...
      k2eesti_harjutus_vastused:
        'query_text_data_type_L2_exercise_answering_questions',
      k2eesti_harjutus_umberjutustus:
        'query_text_data_type_L2_exercise_retelling',
    },
    k2eesti_eksamitoo: 'query_text_data_type_L2_examination',
    k2eesti_kontrolltoo_test: 'query_text_data_type_L2_test',
    k2eesti_tolge: 'query_text_data_type_L2_translation',
  ...
  cwUSEqQLt: {
    query_text_data_type_academic_studies: {
      ...
      ak_eriala_kursusetoo:
        'query_text_data_type_academic_studies_course_paper',
      ...
      ak_eriala_seminaritoo:
        'query_text_data_type_academic_studies_seminar_paper',
      ak_eriala_ulevaade: 'query_text_data_type_academic_studies_overview',
    },
    query_text_data_type_academic_research: {
      ak_uurimus_artikkel:
        'query_text_data_type_academic_research_research_article',
      ak_uurimus_ettekanne:
        'query_text_data_type_academic_research_presentation',
      ak_uurimus_kokkuvote: 'query_text_data_type_academic_research_summary',
      ak_uurimus_batoo:
        'query_text_data_type_academic_research_bachelors_thesis',
      ...
      ak_uurimus_pdhtoo:
        'query_text_data_type_academic_research_doctoral_thesis',
    },
  },
};
